...
export default function LoadingSkeleton({count}:any) {
  ...
  return (
    ...
    {Array.from({ length: skeletonCount }).map((_, index) => (
      <div className="max-w-xs md:max-w-sm lg:max-w-md mx-auto border-2 border-gray-300 mb-5 p-5 font-sans cursor-pointer hover:mb-[-2px]" key={index}>
        <Skeleton width={250} baseColor="#989898" height={100} className='ml-5 mb-2'/>    
